...
TEMPLATES = {
    ...
    "signs": {
        ...
        4: {
            "A": {"subject": "the real cost of approving artwork over email", "template_name": "ireland_signs_seq4_a"},
    ...
    "apparel": {
        ...
        4: {
            "A": {"subject": "chasing 40 people for sizes over email", "template_name": "ireland_apparel_seq4_a"},
    ...
    "print": {
        ...
        4: {
            "A": {"subject": "the hidden cost of quoting in promo", "template_name": "ireland_print_seq4_a"},
