...
class SocialAccount(BaseModel):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='social_accounts')
...
class SocialPostDelivery(BaseModel):
    ...
    account = models.ForeignKey(SocialAccount, on_delete=models.CASCADE, related_name='deliveries')
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='pending')
